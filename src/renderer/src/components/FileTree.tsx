        ...
        >
          ...
          {node.isFolder ? (
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
                ...
                <span className="text-[11px] font-semibold text-zed-muted truncate uppercase tracking-tight">
                    {node.name}
                </span>
            </div>
          ) : (
            <div className="flex items-center gap-2 flex-1 min-w-0">
                <svg className="w-3.5 h-3.5 text-zed-text/40 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
